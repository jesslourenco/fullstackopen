...
describe("Blog app", function () {
  ...
  describe("Login", function () {
    ...
    it("succeeds with correct credentials", function () {
      ...
      cy.get(".notificationMessage").should("contain", "Login successful");
    });
    ...
    it("fails with wrong credentials", function () {
      ...
      cy.get(".notificationMessage").should("contain", "Wrong credentials");
    });
  });
  ...
  describe("When logged in", function () {
    ...
    it("A post can be created", function () {
      ...
      cy.get(".notificationMessage").should("contain", "title has been added!");
    });

    it("A post can be liked", function () {
      cy.createPost({ title: "title", author: "author", url: "url" });
      cy.contains("title").contains("view").click().get("#like-btn").click();
      cy.contains("1 likes");
    });

    it("A post can be deleted by its creator", function () {
      cy.createPost({ title: "title", author: "author", url: "url" });
      cy.contains("title").contains("view").click().get("#del-btn").click();
    ...
    it.only("Posts are ordered by likes", function () {
      ...
      cy.contains("another").contains("view").click();

      cy.contains("another").contains("+like").click().click();
